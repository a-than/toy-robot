        ...
        <div className={classes.tileWrapper}>{tileGrid()}</div>
          ...
          <div className={classes.controlsWrapper}>
            ...
            <Button variant="outlined" className={classes.buttonControl}>
              <Typography className={classes.buttonControlText}>Place</Typography>
            </Button>
              </div>
              <TextField
                  id="outlined-x"
            ...
            <div>
            <Button variant="outlined" className={classes.buttonControl}>
              <Typography className={classes.buttonControlText}>Move</Typography>
            </Button>
            </div>
            <div>
            <Button variant="outlined" className={classes.buttonControl}>
              <Typography className={classes.buttonControlText}>Left</Typography>
            </Button>
            </div>
            <div>
            <Button variant="outlined" className={classes.buttonControl}>
              <Typography className={classes.buttonControlText}>Right</Typography>
            </Button>
            </div>
            <div>
            <Button variant="outlined" className={classes.buttonControl}>
              <Typography className={classes.buttonControlText}>Report</Typography>
            </Button>
            </div>
          </div>
      </div>
